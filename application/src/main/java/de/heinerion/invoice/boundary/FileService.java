...
public class FileService {
   ...
   * @param baseName
   *     of the file to write. Will be enhanced by <code>.tex</code>
   * @param latexMarkup
   ...
   * <p>
   * Determines the exact filename by appending <code>.tex</code> to the baseName.<br> Deletes temp files created during
   * the process of generating the pdf.
   * </p>
   *
   * @param directory
   *     in which the source file resides
   * @param baseName
   *     of the source (internally extended by <code>.tex</code>)
   *
   * @return <code>true</code> on success
   */
